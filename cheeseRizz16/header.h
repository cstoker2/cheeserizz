//DEBUGGING
#define CRSF_DEBUG 0     // show all crf channels on serialusb
#define TELEMETRY 0      // send serial2 data for espnow module
...
#define DEBUG_HLTELEM 0  // Serial debug of hot loop telemetry statuses toggle
 ...
 #define NUMPIXELS 10  // Number of LEDs in dotstar strip 8 top, 2 bot
...
//waveshare ro2350-zero pins:
#define NEOPIXEL_BUILTIN 16 // ? ws2812 miso
//#define NEOPIXEL_POWER 23
...
// Used for  SPI of accelerometer
#define H3LIS331_SCK 6   //  SCL
#define H3LIS331_MISO 7   // SA0
#define H3LIS331_MOSI 8  //  SDA
#define H3LIS331_CS 9    //  CS

//Waveshare Serial1 Pins:
//Tx=0, Rx =1
...
const float RPS_THRESHOLD = 5.0;   // 7 revolutions per second = 420 RPM, 5rps = 300rpm
