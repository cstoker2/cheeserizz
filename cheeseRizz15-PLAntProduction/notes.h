/*
3-17-25 Removing magnetometer, and second led string, just 6 leds for plant versoon.
3-11-25 RCF = 1.12 x Radius x (rpm/1000)2
changing electronics bay for more space to add mounting foam.
